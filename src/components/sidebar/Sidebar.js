        ...
        return (
            <div className="sidebar">
                ...
                <ul className="sidebar-nav">
                    ...
                    <li className="sidebar-nav-items"><Link smooth to="/#about" className="links">Experience</Link></li>
                    <li className="sidebar-nav-items"><Link smooth to="/#education" className="links" >Education</Link></li>
                    <li className="sidebar-nav-items"><Link smooth to="/#education" className="links" >Skills</Link></li>
                    <li className="sidebar-nav-items"><Link smooth to="/#interest" className="links">Interest</Link></li>
                    <li className="sidebar-nav-items"><Link smooth to="/#education" className="links" >Awards</Link></li>
